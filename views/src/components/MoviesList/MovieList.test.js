...
var _MoviesList = _interopRequireDefault(require("./MoviesList"));
...
var itemsList = [{
  ...
  "poster_path": "https://image.tmdb.org/t/p/w500/yPisjyLweCl1tbgwgtzBCNCBle.jpg",
...
describe('<MovieList /> component: ', function () {
  it('Should render correctly', function () {
    var wraper = (0, _enzyme.shallow)(_react.default.createElement(_MoviesList.default, {
      movies: itemsList
    }));
    expect(wraper).toMatchSnapshot();
  });
  it('Should render items correctly', function () {
    var wrapper = (0, _enzyme.mount)(_react.default.createElement(_MoviesList.default, {
      movies: itemsList
    }));
    expect(wrapper.find('MoviesListCard')).toHaveLength(10);
  });
});