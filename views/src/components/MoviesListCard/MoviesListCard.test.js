...
var _MoviesListCard = _interopRequireDefault(require("./MoviesListCard"));
...
describe('<MoviesListCard /> component', function () {
  it('Should render correctly', function () {
    var wrapper = (0, _enzyme.shallow)(_react.default.createElement(_MoviesListCard.default, itemsList[0]));
